...
public class AfficheInterfacePrincipal {
     ...
     *
     * @param stack
     * @param kelvin_celcius Methode static permettant d'afficher sur
     * l'interface principale la temperature sur la carte en kelvin ou en
     * celcius
     */
    public static void Afficher(VBox V, VBox v1, VBox v2, ImageView imgviewTempsActuel, ChoiceBox C, String kelvin_celcius,MyModel model) {
